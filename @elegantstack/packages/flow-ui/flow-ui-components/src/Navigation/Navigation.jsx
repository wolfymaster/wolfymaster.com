...
const Navigation = ({
  ...
  const wrapperVariant = buildResponsiveVariant('lists.links', containerVariant || variant)[0];
  const linkVariant = buildResponsiveVariant('links', variant)[0];
